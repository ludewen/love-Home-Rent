            ...
            <form class="form-horizontal style-form" method="post" action="" enctype="multipart/form-data"
                ...
                <div class="modal-body">
                    <div class="form-group" style="border:none;">
                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">申请人:</span>
                        <div class="col-sm-6">
                            <input type="text" id="modal-title" check-type="required" value="" name="ownerName"
                                   class="form-control">
                    ...
                    <div class="form-group" style="border:none;">
                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">身份证号码:</span>
                        <div class="col-sm-6">
                            <input type="text" id="modal-ownerIdcard" check-type="required" value="" name="ownerIdcard"
                                   class="form-control">
                            <span class="help-block"></span>
                        </div>
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">申请描述:</span>
                        <div class="col-sm-8">
                            <textarea id="modal-content" name="requestDesc" check-type="required"
...
<%--                    </div>--%>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btn_push_files" onclick="updataModel(${owner.rgId})"
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form class="form-horizontal style-form" method="get"
                          action="${pageContext.request.contextPath}/owner/findAllOwner"
                                ...
                                <a href="${pageContext.request.contextPath }/owner/pushRequestOwner">
                                    <button type="button" class="btn btn-success">
                                        <span class="glyphicon glyphicon-user"
                                              style="color: rgb(255,255,255); font-size: 12px;text-shadow: rgb(255,255,255) 0px 0px 0px; ">&nbsp;房东申请</span>
                                    </button>
                                </a>
                        ...
                        <div class="form-group" style="border:none;">
                            ...
                            <div class=" col-sm-4" style="float:left;margin-left:10px;">
                                ...
                                <input type="text" name="ownerName" value="" class="form-control"
                                       style="width:40%;height:28px;float:left;">
                            </div>
...
<%--                                    <option value="2">忽略</option>--%>
                        ...
                        <div class="form-group" style="border:none;">
                            <div class=" col-sm-5" style="float:left;margin-left:40px;">
                                ...
                                <input type="text" name="ownerIdcard" value="" class="form-control"
                            ...
                            <div class=" col-sm-5" style="float:left;margin-left:10px;">
                                ...
                                <input type="text" class="form-control round-form" name="finalTime" id="finalTime"
                                       placeholder="终止时间" style="width:30%;height:28px;float:left;">
                            </div>
                        </div>
                        <div class="form-group" style="border:none;">
                ...
                <table class="table ">
                    ...
                    <c:forEach items="${pageOwnerInfo.list}" var="pageOwner">
                        ...
                        <tr class="mylist">
                            ...
                            <td style="text-align:center;"><fmt:formatDate value='${pageOwner.ownerCreateTime}'
                            ...
                            <td style="text-align:center;">
                                <c:if test="${not empty pageOwner.ownerIssuccess  or pageOwner.ownerStatus == 1}">
                                    <!-- 你根据原型图修改操作的地方 -->
                                    <button type="button" onclick="edit_btn(${pageOwner.ownerId})" id="edit_btn"
                                            class="btn btn-primary btn-xs" data-toggle="modal"
                                            u-id="${pageOwner.ownerId}"><i class="fa fa-pencil"></i>
                                        编辑
                                    </button>
                                ...
                                <c:if test="${empty pageOwner.ownerIssuccess  and pageOwner.ownerStatus == 0}">
                                    ...
                                    <button type="button" onclick="del_btn(${pageOwner.ownerId})"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <li><a href="${pageContext.request.contextPath }/owner/findAllOwner?pageNo=1">首页</a>
                                </li>
                                <li>
                                    <c:if test="${pageOwnerInfo.hasPreviousPage}">
                                        <a href="${ pageContext.request.contextPath }/owner/findAllOwner?pageNo=${pageNum-1}"
                                           aria-label="Previous">
                                ...
                                <c:forEach items="${pageOwnerInfo.navigatepageNums}" var="page_num">
                                    ...
                                    <c:if test="${page_num != pageOwnerInfo.pageNum}">
                                        <li>
                                            <a href="${ pageContext.request.contextPath }/owner/findAllOwner?pageNo=${page_num}">${page_num}</a>
                                        </li>
                                    </c:if>
                                </c:forEach>
                                <li>
                                ...
                                <li>
                                    <a href="${ pageContext.request.contextPath }/owner/findAllOwner?pageNo=${pageOwnerInfo.pages}">末页</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
