            ...
            <form class="form-horizontal style-form" method="post" action="" enctype="multipart/form-data"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">房屋地址:</span>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">房屋介绍:</span>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        ...
                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">房龄:</span>
                        <div class="col-sm-2">
                            <input type="text" readonly="readonly" value="" id="modal-liveTime" class="form-control">
                        </div>

                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">房屋面积:</span>
                        <span class="col-sm-4" id="modal-roomArea"
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        ...
                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">房租:</span>
                        <span class="col-sm-4" id="modal-price"
                              style="color:#5bc0de;font-size:16px;float:left;height:28px;text-align:left;line-height:28px;"></span>

                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">是否装修:</span>
                        <span class="col-sm-3" id="modal-renovationint"
                              style="color:#5bc0de;font-size:16px;float:left;height:28px;text-align:left;line-height:28px;"></span>
                    </div>
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        ...
                        <span class="col-sm-3"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">总共楼层数:</span>
                        <span class="col-sm-2" id="modal-allFloor"
                              style="color:#5bc0de;font-size:16px;float:left;height:28px;text-align:left;line-height:28px;"></span>

                        <span class="col-sm-3"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">房屋所在楼层:</span>
                        <span class="col-sm-2" id="modal-isFloor"
                              style="color:#5bc0de;font-size:16px;float:left;height:28px;text-align:left;line-height:28px;"></span>
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        ...
                        <span class="col-sm-3"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">用户身份证:</span>
                        <div class="col-sm-6">
                            <input type="text" readonly="readonly" name="user_idcard" value="" id="modal-user_idcard"
                                   class="form-control">
                        </div>
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        <span class="col-sm-3"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">用户电话:</span>
                        <div class="col-sm-3">
                        ...
                        <span class="col-sm-3"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">用户性别:</span>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        <span class="col-sm-3"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">用户地址:</span>
                        <div class="col-sm-6">
                            <input type="text" readonly="readonly" name="user_address" value="" id="modal-user_address"
                                   class="form-control">
                        </div>
                    ...
                    <div class="form-group">
                        <span class="col-sm-3"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">房屋图片:</span>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form class="form-horizontal style-form" method="get"
                          action="${pageContext.request.contextPath}/rentout/findAllRentOut"
                        ...
                        <div class="form-group" style="border:none;margin-top:5px;">
                                ...
                                <a href="${pageContext.request.contextPath }/rentout/pushRoom">
                                    <button type="button" class="btn btn-success">
                                        <span class="glyphicon glyphicon-link"
                                              style="color: rgb(255,255,255); font-size: 12px;text-shadow: rgb(255,255,255) 0px 0px 0px; ">&nbsp;发布房屋信息</span>
                                    </button>
                                </a>
                                <button type="button" class="btn btn-success" id="user_jihuo_all">
                                    <span class="glyphicon glyphicon-list"
                                          style="color: rgb(255,255,255); font-size: 12px;text-shadow: rgb(255,255,255) 0px 0px 0px; ">&nbsp;全部上架</span>
                                </button>
                            ...
                            <button type="submit" class="btn btn-round btn-warning"
                                    style="height:28px;text-align:right;line-height:28px;">
                        ...
                        <div class="form-group" style="border:none;">
                            ...
                            <div class=" col-sm-5" style="float:left;">
                                ...
                                <input type="text" name="Info" class="form-control bor3" value=""
                        ...
                        <div class="form-group" style="border:none;">
                            <div class=" col-sm-5" style="float:left;margin-left:40px;">
                                ...
                                <input type="text" class="form-control round-form  bor3" id="minPriceBegin"
                                       maxlength="10" name="PriceBegin" placeholder="最低价格"
                                       style="width:30%;height:28px;float:left;">
                                ...
                                <input type="text" class="form-control round-form  bor3" name="PriceEnd" maxlength="10"
                        ...
                        <div class="form-group" style="border:none;">
                            ...
                            <div class=" col-sm-5" style="float:left;margin-left:40px;">
                                ...
                                <input type="text" class="form-control round-form  bor3" id="dateStart" name="dateStart"
                                ...
                                <input type="text" class="form-control round-form  bor3" name="finalTime" id="finalTime"
                        ...
                        <div class="form-group" style="border:none;">
                            <div class=" col-sm-5" style="float:left;margin-left:40px;">
                                ...
                                <input type="text" name="userIdCard" class="form-control bor3" value=""
                                       style="width:60%;height:28px;float:left;">
                    ...
                    <c:forEach items="${pageRentoutInfo.list}" var="pageRentout">
                        ...
                        <tr class="mylist">
                            ...
                            <td style="text-align:center;"><span
                                    style="color: #5bc0de;">￥${pageRentout.roomPrice}</span></td>
                            ...
                            <td style="text-align:center;"><fmt:formatDate value='${pageRentout.outCreateTime}'
                                                                           type='date' pattern='yyyy-MM-dd'/></td>
                            <td style="text-align:center;">
                                <c:if test="${pageRentout.outStatus == 1}">
                                    <!-- 你根据原型图修改操作的地方 -->
                                    <button type="button" onclick="edit_btn(${pageRentout.rgId})" id="edit_btn"
                                            class="btn btn-primary btn-xs" data-toggle="modal"
                                            u-id="${pageRentout.rgId}"><i class="fa fa-pencil"></i>
                                        编辑
                                    </button>
                                ...
                                <c:if test="${pageRentout.outStatus == 2}">
                                    ...
                                    <button type="button" onclick="jihuo_btn(${pageRentout.rgId})"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <li><a href="${pageContext.request.contextPath }/rentout/findAllRentOut?pageNo=1">首页</a>
                                </li>
                                <li>
                                    <c:if test="${pageRentoutInfo.hasPreviousPage}">
                                        <a href="${ pageContext.request.contextPath }/rentout/findAllRentOut?pageNo=${pageNum-1}"
                                           aria-label="Previous">
                                ...
                                <c:forEach items="${pageRentoutInfo.navigatepageNums}" var="page_num">
                                    ...
                                    <c:if test="${page_num != pageRentoutInfo.pageNum}">
                                        <li>
                                            <a href="${ pageContext.request.contextPath }/rentout/findAllRentOut?pageNo=${page_num}">${page_num}</a>
                                        </li>
                                    </c:if>
                                </c:forEach>
                                <li>
                                ...
                                <li>
                                    <a href="${ pageContext.request.contextPath }/rentout/findAllRentOut?pageNo=${pageRentoutInfo.pages}">末页</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
...
<script>
    ...
    $("#user_delete_all").click(function () {
        ...
        // alert(del_id_strs);
        if (confirm("确定下架【" + userNames + "】的房屋信息吗?")) {
            $.ajax({
    ...
    $("#user_jihuo_all").click(function () {
        ...
        // alert(del_id_strs);
        if (confirm("确定上架【" + userNames + "】的房屋信息吗?")) {
            $.ajax({
