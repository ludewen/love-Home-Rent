...
<%--                                          height="114" alt="下载MyHomeAPP"></div>--%>
<%--            <div class="qr-code-box"><img src="${pageContext.request.contextPath}/img/erweima.png" width="137"--%>
<%--                                          height="114" alt="关注MyHome公众号"></div>--%>
<%--        </div>--%>
...
<%--        <div class="site-info">Copyright © 2012-2018 lianjia.com. All Rights 经营许可证号川***-*****<a href="" target="_blank"--%>
...
<%--        </div>--%>
        ...
        <ul class="bottom-nav" >
            ...
            <li><a href="${pageContext.request.contextPath}/main/toShowAsFor">关于MyHome</a></li>


            <li><a href="${pageContext.request.contextPath}/main/toShowPushMessage">联系MyHome</a></li>
        </ul>
    </div>
