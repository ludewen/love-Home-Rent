                            ...
                            <div class=" col-sm-3" style="float:left;">
                                <button type="button" class="btn btn-success" onclick="jihuodecfm()"
                                    ...
                                    <span class="glyphicon glyphicon-user"
                                          style="color: rgb(255,255,255); font-size: 12px;text-shadow: rgb(255,255,255) 0px 0px 0px; ">&nbsp;添加</span>
                                </button>
                            ...
                            <div class=" col-sm-5" style="float:left;">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control"
                                            style="width:45%;font-size:12px;height:28px;text-align: center;" name="sex">
                                        <option value="" selected="selected">请选择</option>
                                        <option value="1">男</option>
                                        <option value="0">女</option>
                                    </select>
