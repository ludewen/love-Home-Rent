...
<div class="page-wrap on-register">
            ...
            <div class="fields">
                ...
                <div class="extra">
                    <div class="extra-left" style="color:#36353A;text-align:center;font-size:12px">
                        ...
                        <span style="color: white">同意</span> <a href="javascript:;" class="site-protocol js-open-modal" data-target="#modal-protocol">《MyHome服务条款》</a>
                    </div>
                    <span class="extra-right" style="font-size:12px;">
                        <span style="color: white">已有账号？现在就</span>  <a href="${pageContext.request.contextPath}/main/toShowLogin" class="to-regi">登录</a>
                    </span>
                </div>
            </div>
        </form>
    ...
    <div class="modal js-modal protocol-modal" id="modal-protocol">
        <div class="modal-inner">
            ...
            <div class="modal-content">
                ...
                <p>
                    (4)MyHome不公开用户的姓名、地址、电子邮箱和笔名，以下情况除外：

                </p>
                <p>
                    &emsp;&emsp;（a）用户授权MyHome透露这些信息。
                </p>
                <p>
                    &emsp;&emsp;（b）相应的法律及程序要求MyHome提供用户的个人资料。如果用户提供的资料包含有不正确的信息，MyHome保留结束用户使用本网站信息服务资格的权利。
                </p>
                <h4>
                    5．
                    用户在注册时应当选择稳定性及安全性相对较好的电子邮箱，并且同意接受并阅读MyHome发往用户的各类电子邮件。如用户未及时从自己的电子邮箱接受电子邮件或因用户电子邮箱或用户电子邮件接收及阅读程序本身的问题使电子邮件无法正常接收或阅读的，只要MyHome成功发送了电子邮件，应当视为用户已经接收到相关的电子邮件。电子邮件在发信服务器上所记录的发出时间视为送达时间。
                ...
                <p>
                    MyHome有权在必要时增加或修改服务条款，本网站服务条款一旦发生变动，将会在本网站页面上提示修改内容。变更后的条款一经在本网站公布后，立即自动生效。如果不同意所改动的内容，用户可以主动取消获得的本网站信息服务。如果用户继续享用本网站信息服务，则视为接受服务条款的变动。MyHome保留随时修改或中断本网站服务而不需通知用户的权利。MyHome行使修改或中断服务的权利，不需对用户或第三方负责。
                ...
                <p>
                    尊重用户个人隐私是MyHome的一项基本政策。所以，MyHome一定不会在未经合法用户授权时公开、编辑或透露其注册资料及保存在本网站中的非公开内容，除非有法律许可要求或MyHome在诚信的基础上认为透露这些信息在以下几种情况是必要的：
                ...
                <p>
                    用户明确同意信息服务的使用由用户个人承担风险。 MyHome不担保服务不会受中断，对服务的及时性，安全性，出错发生都不作担保，但会在能力范围内，避免出错。
                ...
                <p>
                    MyHome对本网站任何直接、间接、偶然、特殊及继起的损害不负责任，这些损害来自：不正当使用本网站服务，或用户传送的信息不符合规定等。这些行为都有可能导致MyHome或本网站形象受损，所以本网站事先提出这种损害的可能性，同时会尽量避免这种损害的发生。
                ...
                <p>
                    MyHome有判定用户的行为是否符合本网站服务条款的要求和精神的权利，如果用户违背本网站服务条款的规定，MyHome有权终止向用户提供服务或注销该用户的账号。
                ...
                <p>
                    ...
                    <br/>
                    用户超出服务范围或违反服务条款给MyHome或第三人造成损害的，用户应赔偿经济损失包括但不限于诉讼费、保全费、交通费、律师费等。
                </p>
                <h4>
                    14．结束服务
                ...
                <p>
                    用户或MyHome可随时根据实际情况中断一项或多项服务。MyHome不需对任何个人或第三方负责而可以随时中断服务。用户若反对任何服务条款的建议或对后来的条款修改有异议，或对本网站服务不满，用户可以行使如下权利：
                ...
                <p>
                    本网站定义的信息内容包括：文字、软件、声音、相片、录像、图表；在广告中全部内容；本网站为用户提供的其它信息。所有这些内容受版权、商标、标签和其它财产所有权法律或知识产权相关法律的保护。所以，用户只能在MyHome和广告商授权下才能使用这些内容，而不能擅自复制、再造这些内容、或创造与内容有关的派生产品。
                ...
                <p>
                    本网站信息服务条款要与中华人民共和国的法律解释一致。用户和MyHome一致同意服从MyHome所在地有管辖权的法院管辖。如发生本网站服务条款与中华人民共和国法律相抵触时，则这些条款将完全按法律规定重新解释，同时这些条款则依旧保持对用户的约束力。
                </p>
            </div>
            <div class="modal-ft">
    ...
    <div class="corp-info">
        Copyright &copy; 2012-2018 uoko.com（江西MyHome**公寓管理有限公司）. All Rights Rerved 蜀ICP备130****38号-1
    </div>
</div>
