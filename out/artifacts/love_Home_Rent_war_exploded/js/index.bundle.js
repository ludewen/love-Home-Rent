!function (i) {
    ...
    $(".slider-list").slick({
        ...
        autoplaySpeed: 7e3,
        dots: !0,
        prevArrow: '<a href="javascript:" class="rslides_nav prev">Previous</a>',
        nextArrow: '<a href="javascript:" class="rslides_nav next">next</a>',
        lazyLoad: "progressive"
    }), $(".slider-list").find("li.item").each(function () {
        this.style.backgroundColor = $(this).attr("data-bg")
    }), $("#video-wrap").one("click", function () {
        var i = $(this), e = i.attr("data-video-type"), t = i.attr("data-src"), o = i.attr("data-video-width"),
            s = i.attr("data-video-height");
        $.getScript("/Content/js/async_js/video.js", function () {
            videojs.options.flash.swf = "./media/video-js.swf";
            var n = $('<video id="intro-video" controls preload="auto" width="' + o + '" height="' + s + '" class="video-js vjs-default-skin"><source  type="video/' + e + '"></video>');
            n.find("source")[0].src = t, i.find("img").replaceWith(n), videojs(n[0], {}, function () {
                this.play()
            })
        })
    })
