...
<head>
    ...
    <title>租房信息,单间出租,青年公寓出租-MyHome</title>
    <meta name="keywords"/>
    <meta name="description"
          content="MyHome成都租房网提供单间出租,宜家风格精装修的合租房.是成都年轻人喜爱的青年公寓,免费wifi,家具齐全,立即签约立即拎包入住.致力于为年轻人打造租房时代的美好回忆。"/>
            ...
            <div class="container-sm">
                <div class="filter-board">
                    <div class="filter-hd"><span class="hd-item active">条件找房</span><a
                            ...
                            class="sprites icon-loc3"></i>地图查附近</a></div>
                    <div class="filter-bd">
