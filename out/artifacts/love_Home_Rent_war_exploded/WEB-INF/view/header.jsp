    ...
    <div class="container clearfix">
        <div class="uoko-navbar-left">
            ...
            <div class="city-selection">
                ...
                <input type="hidden" value="珠海" id="curr-city-name"/>
                <input type="hidden" value="30.679943" id="curr-city-latitude"/>
                <input type="hidden" value="104.067923" id="curr-city-longitude"/>

                <a href="javascript:;" data-target="#city-list" class="city-cur1 js-drop-down">珠海</a>
        ...
        <div class="uoko-navbar-right login-box">
            <c:if test="${empty user}">
                <a href="${pageContext.request.contextPath}/main/toShowLogin" target="_blank">登录</a><span>|</span><a
