...
<head>
    ...
    <style>
        ...
        body {
            background-image: url("${pageContext.request.contextPath}/img/backgroundLud.jpg");
...
<div class="page-wrap">
    ...
    <div class="page-main" id="page-main">
        ...
        <div class="banner-slider js-banner-slider" >
            <ul class="slider-list"  >
                ...
                <a href="${pageContext.request.contextPath}/rentout/findRentOut" target="_blank">
                    <li style="background-color: rgba(0, 0, 0, 0.5)" class="item" data-banner-id="287">
                        <img src="/img/loading-jd.gif" style="z-index: 998"
                             data-original="${pageContext.request.contextPath}/img/backgroundLud.jpg" width="1263" height="300">
                    </li>
                </a>
            ...
            <div class="container">
                <div class="search-tool">
                    <form method="get" action="${pageContext.request.contextPath}/rentout/findRentOut">
                        ...
                        <input type="submit" value="搜索" class="icon-search-btn search-btn "
                               >
                    </form>
                </div>
            </div>
                <%--<a href="${pageContext.request.contextPath}/main/toShowMap" class="sprites icon-map search-by-map"><span
                        class="text-hidden">地图找房</span></a>--%>
                <div class="hot-area">
                    <span><b>热门区域：</b></span>
                </div>
            </div>
                ...
                <ul class="gallery">
                    <c:forEach var="room" items="${rooms}">
                        <li class="gallery-item">
                            <div class="item-img">
                                <a href="${pageContext.request.contextPath }/rentout/findRoomById/${room.rgId}"
                                   target="_blank"><img
                                        src="${pageContext.request.contextPath}/upload/${room.roomPicture}" width="318"
                                        height="212"></a>
                            </div>
                            <div class="item-desc">
                                <span class="item-tag item-tag-standard"></span>
                                <div class="item-text">为MyHome统一标准化装修，多属房龄较短的电梯公寓，在裸房基础上完成精装全配。</div>
                                <a href="${pageContext.request.contextPath }/rentout/findRoomById/${room.rgId}"
                                   target="_blank" title="${room.roomAddress}步行街附近 公交直达世纪城 中心美地 ${room.roomDesc}"
                                   class="item-tit">${room.roomAddress}步行街附近 公交直达 交通方便 中心美地</a>
                            </div>
                            <div class="item-info">
        ...
        <div class="reason">
            <h2 class="reson-tit"><span class="text-hidden">选择MyHome的理由 top5</span></h2>
                ...
                <div class="adv-item">
                    <a href="javascript:;">
                        <img src="${pageContext.request.contextPath}/img/w3w.jpg"
                             ...
                             wid width="525" height="330" alt="MyHome">
                    </a>
                </div>
