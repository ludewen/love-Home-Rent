            ...
            <form class="form-horizontal style-form" method="post" action="" enctype="multipart/form-data"
                ...
                <div class="modal-body">
                    <div class="form-group" style="border:none;">
                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">留言标题:</span>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        <span class="col-sm-2"
                              style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">留言内容:</span>
                        <div class="col-sm-8">
                            <textarea id="modal-content" name="content" check-type="required"
                    ...
                    <c:if test="${empty message.userId}">
                        ...
                        <div class="form-group" style="border:none;margin-top:30px;">
                            ...
                            <span class="col-sm-2"
                                  style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">关联用户:</span>
                            <div class="col-sm-3">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btn_push_files" onclick="updataModel(${message.messageId})"
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form class="form-horizontal style-form" method="get"
                          action="${pageContext.request.contextPath}/message/findAllMessage"
                                ...
                                <a href="${pageContext.request.contextPath }/main/toShowPushMessage">
                                    <button type="button" class="btn btn-success">
                                        <span class="glyphicon glyphicon-user"
                                              style="color: rgb(255,255,255); font-size: 12px;text-shadow: rgb(255,255,255) 0px 0px 0px; ">&nbsp;添加留言</span>
                                    </button>
                                </a>

                                <button type="button" class="btn btn-danger" onclick="deledecfm()" id="user_delete_all">
                                    <span class="glyphicon glyphicon-trash"
                                          style="color: rgb(255,255,255); font-size: 12px;text-shadow: rgb(255,255,255) 0px 0px 0px; ">&nbsp;全部删除</span>
                                </button>
                ...
                <table class="table ">
                    ...
                    <c:forEach items="${pageMessageInfo.list}" var="pageMessage">
                        ...
                        <tr class="mylist">
                            ...
                            <td style="text-align:center;"><fmt:formatDate value='${pageMessage.mCreateTime}'
                                                                           type='date' pattern='yyyy-MM-dd'/></td>
                            <td style="text-align:center;">${pageMessage.user.name}</td>
                            <td style="text-align:center;">
                                <c:if test="${pageMessage.mStatus == 1}">
                                    <!-- 你根据原型图修改操作的地方 -->
                                    <button type="button" onclick="edit_btn(${pageMessage.messageId})" id="edit_btn"
                                            class="btn btn-primary btn-xs" data-toggle="modal"
                                            u-id="${pageMessage.messageId}"><i class="fa fa-pencil"></i>
                                        编辑
                                    </button>
                                    <a href="${pageContext.request.contextPath}/message/deleteMessage/${pageMessage.messageId}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        当前第${pageMessageInfo.pageNum}页,共${pageMessageInfo.pages}页,共${pageMessageInfo.total}条记录
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <li><a href="${pageContext.request.contextPath }/message/findAllMessage?pageNo=1">首页</a>
                                </li>
                                <li>
                                    <c:if test="${pageMessageInfo.hasPreviousPage}">
                                        <a href="${ pageContext.request.contextPath }/message/findAllMessage?pageNo=${pageNum-1}"
                                           aria-label="Previous">
                                ...
                                <c:forEach items="${pageMessageInfo.navigatepageNums}" var="page_num">
                                    ...
                                    <c:if test="${page_num != pageMessageInfo.pageNum}">
                                        <li>
                                            <a href="${ pageContext.request.contextPath }/message/findAllMessage?pageNo=${page_num}">${page_num}</a>
                                        </li>
                                    </c:if>
                                </c:forEach>
                                <li>
                                ...
                                <li>
                                    <a href="${ pageContext.request.contextPath }/message/findAllMessage?pageNo=${pageMessageInfo.pages}">末页</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
