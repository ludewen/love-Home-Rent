...
<head>
    ...
    <title>出租房租前须知 - MyHome月租房疑问解答，非中介！</title>
    <meta name="keywords"/>
                            ...
                            <dl class="navwrap" id="fixed-nav">
                                ...
                                <dd>
                                    <ul class="nav bs-sidenav list-unstyled">
                                        <li>
                                            <a href="#1" title="MyHome简介">
                                                MyHome简介
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#2" title="MyHome找房预约指南">
                                                MyHome找房预约指南
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#3" title="MyHome提供的房租月付及费用计算方式">
                                                MyHome提供的房租月付及费用计算方式
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#4" title="MyHome交定方式及签约">
                                                MyHome交定方式及签约
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#5" title="MyHome长租与短租">
                                                MyHome长租与短租
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#6" title="MyHome双人间与单人间">
                                                MyHome双人间与单人间
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#7" title="MyHome租客认证">
                                                MyHome租客认证
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#8" title="MyHome饲养宠物规则">
                                                MyHome饲养宠物规则
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#9" title="MyHome搬家券领取">
                                                MyHome搬家券领取
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <dd>
                                    <ul class="nav bs-sidenav list-unstyled">
                                        <li>
                                            <a href="#11" title="MyHome保洁服务">
                                                MyHome保洁服务
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#13" title="MyHome代收代缴服务">
                                                MyHome代收代缴服务
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#14" title="MyHome巡房服务">
                                                MyHome巡房服务
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#15" title="MyHome暖心客服">
                                                MyHome暖心客服
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#16" title="MyHome投诉服务">
                                                MyHome投诉服务
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#18" title="MyHome管家服务">
                                                MyHome管家服务
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <dt>MyHome承诺<i class="icon"></i></dt>
                                <dd>
                                    <ul class="nav bs-sidenav list-unstyled">
                                        <li>
                                            <a href="#25" title="MyHome承诺">
                                                MyHome承诺
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal" style="text-indent:21.0pt;">
                                        <span>无中介费、宜家风格、精装全配、公寓式服务、网络社交平台——这是MyHome的几个标签</span>
                                    </p>
                                    MyHome成立于<span>2012</span>年，作为互联网时代新型租房模式的引领者，MyHome为城市租房人群提供品质长租公寓产品，以及围绕租后服务和居住社交衍生的其他服务。我们以标准化的方式打造租住环境，更好的满足租客需求。运营四年来，我们一直努力践行“打造租房时代美好回忆”的品牌承诺，致力为都市年轻人打造更多样化的居住和社交生活体验。
                                    <p>
                                        <br/>
                                    </p>
                                    <p>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        方式一：直接拨打<span>10105288</span>MyHome官网预约电话<span></span>
                                    </p>
                                    <p class="MsoNormal">
                                    ...
                                    <p class="MsoNormal">
                                        &nbsp; &nbsp;不同的MyHome管家会负责不同的区域，所以在预约时请告知清楚需求，让管家帮忙推荐可以最大限度节省宝贵的时间
                                    </p>
                                    <p class="MsoNormal">
                                ...
                                <div class="content">
                                    ...
                                    <p>
                                        ...
                                        *需要满足签约一年及两年及以上的条件（签约两年的福利请看“关于租期的选择”）<br/>
                                        ...
                                        除去金融公司收取的分期手续费，MyHome不会额外收费；活动期间，根据不同的金融产品，MyHome还会给到客户利息补贴或服务费折扣的优惠。
                                    </p>
                                    <p>
                                        <br/>
                                        6、分期月付办理流程：<br/>
                                        ...
                                        例如：MyHome提供的“海尔月付”<br/>
                                        <br/>
                                        海尔月付（2年）：<br/>
                                        【利息】利息由MyHome一次性支付<br/>
                            ...
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        ...
                                        2、在线支付：<br/>
                                        通过关注MyHome官方微信（uokohome）或注册登录我们的官方网站，在【我的账单】列表查看账单并进行支付。<br/>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        三、<span style="line-height:1.5;">&nbsp;如果在长租期间工作地点发生变化，你可以选择顶租，直接将房间转租给下一位租客；或是选择换房，直接搬到离工作地点更近的MyHome</span><span
                                            style="line-height:1.5;">房间，深受年轻人喜爱的MyHome房间风格不愁顶，全城房源分布不愁换！</span>
                                    </p>
                            ...
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <div style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                                        凡是MyHome新签约租客，可领取20元蓝犀牛搬家抵金券（限蓝犀牛新注册用户）。
                                    </div>
                                    <div style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                                        搬家券使用规则：
                                    </div>
                                    <div style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                                        1、通过MyHome官网及APP入口进入优惠券领取页面，填写手机及验证码，符合条件即可获得搬家券。
                                    </div>
                                    <div style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                                    ...
                                    <p style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                                        5、MyHome为租客推荐租房搬家福利，具体搬家服务及责任均由蓝犀牛承担。
                                    </p>
                                    <p style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        MyHome保洁旨在为每一位租客打造清洁、舒适的居住环境。自推出以来已累计为租客提供上万次保洁服务，专业的保洁团队为您的居住生活提供强有力的后勤保障。<span>&nbsp;&nbsp;&nbsp; </span><b>&nbsp;&nbsp;&nbsp; </b>
                                    </p>
                                    <p class="MsoNormal">
                                        <b>&nbsp;</b>
                                    </p>
                            ...
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <tr>
                                        ...
                                        <td width="470" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">部分房源由服务管家代缴，每月抄录电表底度<span>/</span>余额，按照实际使用情况分摊至每人，每三个月由MyHome收取一次费用。特殊房源除外。</span><span
                                                    style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="470" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">由服务管家代缴，按照实际产生费用分摊至每个房间，每三个月由MyHome收取一次费用。特殊房源除外。</span><span
                                                    style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                    </tr>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        关注MyHome微信公众号<span>UOKOHome,</span>选择自主服务的投诉建议或联系10105288客服协助<span> &nbsp;&nbsp;&nbsp; </span>
                                    </p>
                                    <p class="MsoNormal">
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        变更手机号码：关注MyHome微信服务号<span>Uokohome</span>自助服务，选择修改手机号码。<span></span>
                                    </p>
                                    <p class="MsoNormal">
                                    ...
                                    <p class="MsoNormal">
                                        注：地方银行、邮政储蓄银行、交通银行、华夏银行、中信银行、农业发展银行及农业银行不支持代扣。<span>3. </span>租住人数变更：合同期内变更租住人数，MyHome将会收取<span>200</span>元的变更手续费。<span></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        4.当您收到收费单位的缴费通知时，请及时联系您的服务管家，MyHome可代您缴费，如果您选择自行缴费，请保留好缴费凭证（小票回执、发票）。<span></span>
                                    </p>
                                    <p class="MsoNormal">
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        转租是指租客<span>A </span>要退租，但是找租客<span>B </span>来租住他的房间。即原承租人在承租合同到期前提出解约并自行找到该房屋的新租客的行为为转租。新租客需按当前的政策，与MyHome重新签订承租合同。<span>&nbsp; </span><b>&nbsp;&nbsp;&nbsp; </b>
                                    </p>
                                    <p class="MsoNormal">
                                        <b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp; </b>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        换房是指租客<span>A </span>从MyHome“房间<span>X</span>”换到MyHome“房间<span>Y</span>”，即承租期间，客户提出换到MyHome的另外一间房子<b>&nbsp;
                                        &nbsp;&nbsp;&nbsp; </b>
                                    </p>
                                    <p class="MsoNormal">
                                        <b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        续租是指客户在合同到期后继续租住MyHome房间的情形。<span></span>
                                    </p>
                                    <p class="MsoNormal">
                                    ...
                                    <p class="MsoNormal">
                                        <b>四、特别提示<span>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <br/>
</span></b>超期<span>5</span>天未办理退租<span>/</span>续租手续，MyHome有权收回房屋<b></b>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p>
                                        &nbsp;&nbsp;&nbsp; a：通过微信联系MyHome微信服务号（uokoHome），或致电10105288，向客服人员提出遇到房屋质量问题，提出维修；
                                    </p>
                                    <p>
                            ...
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal" style="margin-left:0cm;text-indent:0cm;" align="left">
                                        ...
                                        MyHome（成都地区租客）于<span>2016</span>年<span>2</span>月<span>22</span>日起全面转为线上支付渠道收款；<span></span>
                                    </p>
                                    <p class="MsoNormal" style="margin-left:0cm;text-indent:0cm;" align="left">
                                    ...
                                    <p class="MsoNormal" align="left">
                                        1、请绑定MyHome微信服务号（<span>uokohome</span>）或者注册登录我们的官方网站，在【账单】列表查看账单并进行支付（支持信用卡）<span></span>
                                    </p>
                                    <p class="MsoNormal" align="left">
                                        2、MyHome提供银联代扣服务，定期从客户提供的银联卡上扣除房屋租金及房屋产生的其他费用<span></span>
                                    </p>
                                    <p class="MsoNormal" align="left">
                                        <b>&nbsp;</b>
                                    </p>
                                    ...
                                    2、在<span>2016</span>年<span>2</span>月<span>22</span>日起，请勿转账至MyHome支付宝和银行账户，感谢大家的支持！
                                    <p>
                                        <br/>
                                    </p>
                                </div>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="p">
                                        <strong>MyHome（成都地区租客）于2016年2月22日起全面启用线上支付渠道收款，届时同步停止使用转账渠道（包含支付宝和银行转账），更方便快捷的缴费方式看这里：</strong>
                                    </p>
                                    <p class="p">
                                        <strong>1、通过关注绑定MyHome微信（uokohome）或者注册登录我们的官方网站，在【账单】列表查看账单并进行支付（支持信用卡）</strong>
                                    </p>
                                    <p class="p">
                                        <strong>2、MyHome提供银联代扣服务，定期从客户提供的银联卡上扣除房屋租金及房屋产生的其他费用</strong>
                                    </p>
                                    <p class="p">
                                        <strong>特别提示：为了您的资金安全，在任何时间地点，请勿向任何非官方渠道获知的账号转账汇款，以免上当受骗。</strong>
                                    </p>
                                    <p class="p">
                                        <strong>在2016年2月22日后，请勿转账至MyHome支付宝和银行账户，我公司将停止转账渠道的到账查询，感谢大家的支持！</strong>
                                    </p>
                                    <div>
                                        <strong><br/>
                                        </strong>
