                ...
                <div class="meta-info">
                    ...
                    <div class="meta-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 ">
                                <input class="form-control" id="ownerName" readonly="readonly" check-type="required"
                                       name="ownerName" type="text" value="${ownerInfo.ownerName}"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 ">
                                <input class="form-control" id="ownerIdcard" readonly="readonly" check-type="required"
                                       name="ownerIdcard" type="text" value="${ownerInfo.ownerIdcard}"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" id="requestDesc" readonly="readonly"
                                          check-type="required" name="requestDesc" type="text" value="" cols="20"
                                          rows="4">${ownerInfo.requestDesc}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" id="uname" name="uname" readonly="readonly" type="text"
                                       value="${ownerInfo.user.name}"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 has-feedback">
                                <input class="form-control" id="age" name="age" readonly="readonly" type="text"
                                       value="${ownerInfo.user.age}"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="job" name="job" readonly="readonly" type="text"
                                       value="${ownerInfo.user.job}"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" id="address" readonly="readonly" name="address" type="text"
                                       value="${ownerInfo.user.address}"/>
                                <span class="field-validation-valid" data-valmsg-for="Career"
                                      data-valmsg-replace="true"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="avatar-upload">
                                <div class="avatar-pic" id="avatar-box" style="cursor:pointer">
                                    <img src="${pageContext.request.contextPath}/upload/${ownerInfo.ownerRoomPhoto}"
                                         id="ownerInfoRoomPhoto"/>
                                </div>
                            </div>
