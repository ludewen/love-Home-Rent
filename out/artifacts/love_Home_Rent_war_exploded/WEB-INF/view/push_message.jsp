            ...
            <div class="container">
                ...
                <div class="contact-content contact-publicity-content">
                    <div class="cont">
                        <h3>投诉方式</h3>
                        <ul class="desc">
                            <li><span>•</span>在线投诉：MyHome官网 > 投诉建议</li>
                            <li><span>•</span>微信投诉：关注官方微信“MyHome”-自助服务内申报投诉</li>
                                        ...
                                        <form id="messageCont">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="Title" data-valihint="取个标题吧"
                                                           class="form-control message_content" check-type="required"/>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label for="UOKOTALK" class="AreaText"><span>* </span>我想说的是：</label>
                                                    <textarea id="UOKOTALK" name="Content" data-valihint="写你要说的内容"
                                                              class="form-control message_content" rows="8"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="UOKOUSER" type="text" name="UserName"
                                                           data-valihint="一定要写姓名哦" class="form-control message_content"
                                                           check-type="required"/>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="UOKOUSERPHONE"
                                                           class="AreaText"><span>* </span>联系方式：</label>
                                                    <input id="UOKOUSERPHONE" type="text" name="Phone"
                                                           data-valihint="留下联系方式吧" class="form-control message_content"
                                                           check-type="required tel"/>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="bk10"></div>
                                    <button id="btnSubmitMessage" type="button"
                                            class="btn btn-lg btn-blue btn-contact btn-valid">提交留言
                                    </button>
                                </div>
