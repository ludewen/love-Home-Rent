...
<div class="page-wrap">
    ...
    <div class="page-main" id="page-main">
        ...
        <div class="container">
            ...
            <form action="${pageContext.request.contextPath}/rentout/addRentOut" onsubmit="return checkForm()"
                ...
                <div class="form-horizontal" id="form-rentGet" role="form" novalidate="novalidate">
                    <div class="form-wrap">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5"><textarea type="text" class="form-control message_content" rows="4"
                                                            name="roomDesc" id="roomDesc"
                                                            check-type="required"></textarea></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4"><input type="text" class="form-control bor3" name="phone" id="phone"
                                                         check-type="required tel"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 mt4">
                                <input type="text" maxlength="6" check-type="required" class="form-control bor3"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 mt4">
                                <input type="text" check-type="required" name="roomAge" class="form-control bor3"
                                       id="roomAge">
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4 mt4">
                                <label class="radio-inline">
                                    <input checked="checked" data-val="true" data-val-required="Gender 字段是必需的。"
                                           name="renovationint" type="radio" value="1"/> <span>是</span>
                                </label>
                                <label class="radio-inline">
                                    <input data-val="true" data-val-required="Gender 字段是必需的。" name="renovationint"
                                           type="radio" value="0"/><span>否</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 mt4">
                                <input type="text" check-type="required" class="form-control bor3" name="roomStructure"
                                       id="roomStructure">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 mt4">
                                <input type="text" check-type="required" check-type="required" class="form-control bor3"
                                       name="roomArea" maxlength="4" id="roomArea">
                            </div>
                            <div class="col-sm-4 mt4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 mt4">
                                <input type="text" check-type="required" class="form-control bor3" name="allFloor"
                                       id="allFloor">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 mt4">
                                <input type="text" check-type="required" class="form-control bor3" name="isFloor"
                                       id="isFloor">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="avatar-upload">
                                <div class="avatar-pic" id="avatar-box" style="cursor:pointer;text-align: center;">
                                    <img src="${pageContext.request.contextPath}/img/loading.gif" width="50%"
                                         height="60%" id="ownerRoomPhoto"/>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-4 mt18">
                                <input type="submit" id="btn_addRentGet"
                                       class="btn  btn-primary btn-cflat btn-valid bor3" value="提交"/>
        ...
        <!-- 发布提示窗口 -->
        <div class="modal fade email-modal" id="email-callback" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="bk20"></div>
                        <button type="button" class="btn btn-primary btn-flat" id="close" data-dismiss="modal">关闭
                        </button>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function checkForm() {
        ...
        if (userId == null || userId == '' || uname == null || uname == '') {
            ...
            return false;
        } else if( roomDesc.length > 250){
            alert("房屋介绍请控制在250字以内！");
            return false;
        }
        else {
            return true;
