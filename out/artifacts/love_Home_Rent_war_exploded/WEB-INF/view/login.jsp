    ...
    <div class="form-box">
        <form action="" id="loginForm" method="post" novalidate>
            <input type="hidden" name="idsrv.xsrf"
                   value="IkObmiJoiw9fJror7cEtvw198ekZw1Axbqv9lEr4NN4i-a92bb10KsfrVCB75GrlCDRo6KGmXYLf_z_WDvEE9_QjlcE"
                   token="model.antiForgery">
            <a href="${pageContext.request.contextPath}/main/toIndex" class="logo logo-2">MyHome</a>
            <div class="error-box" style="margin-top:0;margin-bottom:10px;" id="server-error-box">
                <span></span>
            </div>
            <div class="fields">
                <div class="form-field">
                    <label><input type="text" id="username" autocomplete="off" placeholder="请输入用户名/手机号" name="username"
                                  class="field-ipt" value="" onblur="uname()"></label>
                    <span id="login-error-text" style="text-align: center"></span>

                </div>
                <br>
                <div class="form-field">
                    <label><input type="password" autocomplete="off" placeholder="输入密码" name="password" id="password"
                                  class="field-ipt" value=""/></label>
                </div>
            </div>
...
<%--                </div>--%>
                <div class="extra-right">
                    <span style="color: white">没有账号?现在就</span>  <a href="${pageContext.request.contextPath}/main/toShowReg" class="to-regi">注册</a>
                </div>
            </div>
        </form>
<%--        <div class="corp-info">--%>
<%--            Copyright &copy; 2012-2018 lianjia.com(江西****公寓管理有限公司). All Rights Reserved 蜀ICP备13****638号-1 <i--%>
<%--                class="icon-ga"></i> <span>川公网安备 510****2**885号</span>--%>
<%--        </div>--%>
    </div>
