            ...
            <div class="prod-detail clearfix">
                ...
                <div class="detail-right">
                    <h2 class="detail-tit">【${rentOut.roomAddress}】<span
                            id="loc-name"> ${rentOut.roomDesc}</span></h2>
        ...
        <div id="detailContainer" class="container">
            ...
            <div class="item-info-verbose" id="item-info-verbose">
                <div class="verbose-left">
                    ...
                    <div class="left-block">
                        <div class="block-hd"><span class="sprites icon-detail-tit-label icon-sl-why"></span>为什么选择MyHome？
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <%--
                     <div class="wx-media-group clearfix">
                         <div class="wx-icon">
                             <img src="${pageContext.request.contextPath}/img/uoko_wechat_qrcode.jpg" alt="扫一扫加入MyHome官方微信，有机会赢取大奖！" class="img-responsive" />
                         </div>
                         <div class="wx-hint">
                             <h2>
                                 下载官方租房社交APP<br />
