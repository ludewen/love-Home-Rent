            ...
            <div class="form-horizontal" id="form-rentGet" role="form" novalidate="novalidate">
                <div class="form-wrap">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5"><input type="text" class="form-control bor3" id="title"
                                                     check-type="required"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" maxlength="6" class="col-sm-3" id="minPrice"> <span
                                class="col-sm-3">————</span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 mt4">
                            <input type="text" check-type="required" class="form-control bor3" maxlength="4"
                                   id="roomArea">
                        </div>
                        <div class="col-sm-4 mt4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control bor3" id="phone"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5"><textarea type="text" class="form-control message_content" rows="4"
                                                        id="roomDesc" check-type="required"></textarea></div>

                    </div>

                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-4 mt18">
                            <button type="button" id="btn_addRentGet" onclick="addRentGet()"
                                    class="btn  btn-primary btn-cflat btn-valid bor3">确认
                            </button>
