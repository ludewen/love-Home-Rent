            ...
            <ul class="slider-list"  >
                ...
                <a href="${pageContext.request.contextPath}/rentout/findRentOut" target="_blank">
                    <li style="background-color: rgba(0, 0, 0, 0.5)" class="item" data-banner-id="287">
                        <img src="${pageContext.request.contextPath}/img/backgroundLud.jpg" style="z-index: 1000"
                             width="1263" height="300">
                    </li>
                </a>
                    ...
                    <a href="javascript:;" id="video-wrap" data-video-type="mp4"
                       ...
                       data-video-height="330">
                        <img src="${pageContext.request.contextPath}/img/w2w.jpg"
                             data-original="${pageContext.request.contextPath}/img/vedio_poster.jpg" width="525" height="330">
                    </a>
